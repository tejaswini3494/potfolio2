   ...
   <h4 className="text-blue-950 font-bold text-xl py-2 text-center ">Skills</h4>
    <div className=" flex  flex-col  gap-3   items-center md:flex-row md:justify-center" >
      {SKILLS.map((currEle) => {
        return (
          <>
            <div  style={{backgroundImage:'url("Images/background1.jpg")'}} className=' bg-cover  bg-center   bg-slate-300 p-4 h-96  flex flex-col items-center w-full md:w-64 lg:w-96  mx-auto'>
